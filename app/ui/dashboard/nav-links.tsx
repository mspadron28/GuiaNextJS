  ...
  return (
    <>
      {links.map((link) => {
        ...
        const isActive = pathname === link.href; // Verifica si la ruta actual coincide con el href
        ...
        return (
          <Link
            ...
            text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3
